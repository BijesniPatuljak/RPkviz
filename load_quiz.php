...
echo '<input type="radio" name = ' . $pitanje->id . ' id = ' . $odgovor->ponudjeni_odgovor_number . ' value="' . $odgovor->ponudjeni_odgovor_number . '">';
echo '<label for="' . $odgovor->ponudjeni_odgovor_number . '" value="' . $odgovor->ponudjeni_odgovor_number . '">' . $odgovor->ponudjeni_odgovor_text . '<br>';
		}
